...
import com.example.hemin.fnb.ui.activity.ActivityUserMessage;
...
public class UpdateAboutPresenter extends BasePresenter<ActivityUserMessage> implements UpdateAboutContract.Persenter {
    private UpdateAboutContract.modle modle;
    public  UpdateAboutPresenter(){
