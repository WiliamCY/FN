...
public class Find4Adapter extends RecyclerView.Adapter<Find4Adapter.ViewHolder> {
    private List<Find4Bean.DataBean> beans;
    private Context context;
    private OnRecyclerItemClickListener monItemClickListener;

    public Find4Adapter(Context context,List<Find4Bean.DataBean> beans) {
        this.beans = beans;
    ...
    @NonNull
    @Override
    public Find4Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_card4_view, parent, false);
        Find4Adapter.ViewHolder holder = new Find4Adapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull Find4Adapter.ViewHolder holder, int position) {
        Find4Bean.DataBean bean = beans.get(position);
